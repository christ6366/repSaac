...
public class AccesoController extends Contexto {
    ...
    public void sendPassword() {
        try {
            ...
            utilitarios.enviarMailClave("juanklafuente@gmail.com", "Informacion del sistema", "" + sms, "" + footer);
//            utilitarios.enviarMailClave("bvje2633@ute.edu.ec", "Informacion del sistema", "" + sms, "" + footer);
