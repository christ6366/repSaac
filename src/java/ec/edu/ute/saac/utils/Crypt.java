...
public class Crypt {
    ...
    /**
     * Genera la calve de encriptacion a partir dela lectura del archivo de propiedades, eso lo relaiza solo una ves cuando se encuentre en nulos los valores de encriptacion
     */
    static {
    ...
    /**
     * El algoritmo MD5 sera el que se utilize para encriptar cadenas de caracteres corrspondientes principalmenet a claves de acceso para usuarios, por lo que no se podra
     * recuperar el valor original, para recuperar valores reales se usara otro tipo de encriptacion
     *
